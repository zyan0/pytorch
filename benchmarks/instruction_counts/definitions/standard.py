...
BENCHMARKS: FlatIntermediateDefinition = flatten({
    ...
    "Indexing": {
        # Indexing, particularly advanced indexing, can be quite diverse.
        # However, the benchmark is quite regular and assignment of a scalar
        # and an indexed Tensor excercises both the retreival and assignment
        # paths.
